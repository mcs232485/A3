...
###################################################################
#######  Class Name  LearningSwitch                               #
#######  Purpose Implementation of learning switch functionality  #
###################################################################
...
class LearningSwitch(  app_manager.RyuApp ):
      ...
      def   __init__(  self , *firstlevelargs , **secondlevelargs ):
            super( LearningSwitch     , self ).__init__(*firstlevelargs  , **secondlevelargs  )
      ...
      def   function_for_packet(  self   , myvar  ):  
            ...
            # if the port is already seen then sent to specific port from saved mac port mapping
