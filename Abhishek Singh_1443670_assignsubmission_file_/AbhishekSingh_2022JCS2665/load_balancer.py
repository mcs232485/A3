...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def _packet_in_handler(self, ev):
        ...
        print("Server No ", server_ip_selected, end=" ")
        print("is serving the request")
        ...
        print("Sent to server: " + str(server_ip_selected))
        print("MAC: " + str(server_mac_selected))
        print(" and on switch port: " + str(server_outport_selected))
        ...
        print("<Replied by server " + str(server_ip_selected) + ", MAC: " + str(server_mac_selected))
