...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def handle_tcp_packet(self, datapath, in_port, ip_header, parser, dst_mac, src_mac):
        ...
        if ip_header.dst == self.VIRTUAL_IP:
            ...
            self.logger.info("<==== Added Flow- Route to Server: " + str(server_dst_ip) +
            ...
            self.add_flow(datapath, 20, match, actions)
            self.logger.info("<==== Added Flow- Reverse route from Server: " + str(server_dst_ip) +
